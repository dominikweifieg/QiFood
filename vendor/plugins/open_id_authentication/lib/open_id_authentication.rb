...
module OpenIdAuthentication
  ...
  class Result
    ERROR_MESSAGES = {
      :missing      => t('activerecord.errors.models.user.openid.missing'), #"Sorry, the OpenID server couldn't be found",
      :invalid      => t('activerecord.errors.models.user.openid.invalid'), #"Sorry, but this does not appear to be a valid OpenID",
      :canceled     => t('activerecord.errors.models.user.openid.canceled'), #"OpenID verification was canceled",
      :failed       => t('activerecord.errors.models.user.openid.failed'), #"OpenID verification failed",
      :setup_needed => t('activerecord.errors.models.user.openid.setup_needed'), #"OpenID verification needs setup"
    }
